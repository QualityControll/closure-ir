...
macro_rules! int {
    ($v:expr, $t:ty, $variant:ident) => {{
        ...
        Ok(quote!(::closure_ir::Expr::Constant(::closure_ir::Value::$variant(#parsed))))
    }}
}
...
pub(crate) fn lower_literal(
    ...
    match &literal.lit {
        Lit::Bool(value) => {
            ...
            Ok(quote!(::closure_ir::Expr::Constant(::closure_ir::Value::Bool(#value))))
        }
        Lit::Int(value) => {
            ...
            match suffix {
                "" => {
                    if let Some(ty) = expected_type {
                        ...
                        Ok(quote!(::closure_ir::Expr::Constant(::closure_ir::Value::I32(#parsed))))
                    }
                }
                "i8" => int!(value, i8, I8),
            ...
            match suffix {
                "" => {
                    if let Some(ty) = expected_type {
                        ...
                        Ok(quote!(::closure_ir::Expr::Constant(::closure_ir::Value::F64(#parsed))))
                    }
                }
