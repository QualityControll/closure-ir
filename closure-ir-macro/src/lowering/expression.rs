...
pub(crate) fn lower_expr(expr: &SynExpr, arguments: &[ClosureArgument], locals: &[LocalVariable], expected_type: Option<&Type>) -> syn::Result<TokenStream> {
    match expr {
        ...
        SynExpr::MethodCall(method) => {
            ...
            Ok(quote!(::closure_ir::Expr::Len { sequence: Box::new(#sequence) }))
        }
        ...
        SynExpr::Cast(cast) => {
            ...
            Ok(quote!(::closure_ir::Expr::Cast { expr: Box::new(#value), source_type: <#source_type as ::closure_ir::CompileType>::type_info(), target_type: <#target_type as ::closure_ir::CompileType>::type_info() }))
        }
        SynExpr::Index(index) => {
            ...
            Ok(quote!(::closure_ir::Expr::Index { sequence: Box::new(#sequence), index: Box::new(#index_expr) }))
        }
