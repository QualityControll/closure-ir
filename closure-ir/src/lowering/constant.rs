...
impl<'ctx> Lowering {
    pub(crate) fn lower_constant(
        ...
        let value = match value {
            ...
            Value::I128(v) => context.i128_type().const_int_arbitrary_precision(&[*v as u128 as u64, (*v as u128 >> 64) as u64]).into(),
            ...
            Value::U128(v) => context.i128_type().const_int_arbitrary_precision(&[*v as u64, (*v >> 64) as u64]).into(),
