...
pub enum TypeInfo {
    ...
    U8, U16, U32, U64, U128,
    Bool,
    Array { element: Box<TypeInfo>, length: usize },
...
impl TypeInfo {
    ...
    pub fn is_unsigned_integer(&self) -> bool { matches!(self, Self::U8|Self::U16|Self::U32|Self::U64|Self::U128) }
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct FieldInfo { pub name: String, pub type_info: TypeInfo }
...
primitive!(f32,TypeInfo::F32,f32_type); primitive!(f64,TypeInfo::F64,f64_type);
primitive!(i8,TypeInfo::I8,i8_type); primitive!(i16,TypeInfo::I16,i16_type); primitive!(i32,TypeInfo::I32,i32_type); primitive!(i64,TypeInfo::I64,i64_type); primitive!(i128,TypeInfo::I128,i128_type);
primitive!(u8,TypeInfo::U8,i8_type); primitive!(u16,TypeInfo::U16,i16_type); primitive!(u32,TypeInfo::U32,i32_type); primitive!(u64,TypeInfo::U64,i64_type); primitive!(u128,TypeInfo::U128,i128_type); primitive!(bool,TypeInfo::Bool,bool_type);
impl<T: CompileType, const N: usize> CompileType for [T; N] { fn type_info()->TypeInfo { TypeInfo::Array { element: Box::new(T::type_info()), length: N } } fn llvm_type<'ctx>(c:&'ctx Context)->BasicTypeEnum<'ctx> { c.array_type(T::llvm_type(c), N as u32).into() } }
