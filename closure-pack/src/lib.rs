...
pub fn type_info_of<T, F>(_: F) -> TypeInfo where T: CompileType, F: FnOnce() -> T { T::type_info() }
pub fn type_info_of1<A, T, F>(_: F) -> TypeInfo where A: CompileType, T: CompileType, F: FnOnce(A) -> T { T::type_info() }
